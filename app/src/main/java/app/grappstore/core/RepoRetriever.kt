...
import app.grappstore.util.AtomicFile2
import app.grappstore.util.openConnection
import app.grappstore.util.readByteArray
import app.grappstore.util.readString
import app.grappstore.util.throwResponseCodeException
import app.grappstore.util.writeByteArray
import app.grappstore.util.writeString
...
fun fetchRepo(currentRepo: Repo): Repo {
    return fetchRepoFrom(currentRepo, REPO_BASE_URL)
}
