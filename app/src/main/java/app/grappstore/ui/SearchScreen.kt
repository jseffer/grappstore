...
import app.grappstore.core.PackageSource
import app.grappstore.core.mainHandler
import app.grappstore.databinding.SearchScreenBinding
import app.grappstore.util.requestKeyboard
...
class SearchScreen : PackageListFragment<SearchScreenBinding>() {
    ...
    override fun onViewsCreated(views: SearchScreenBinding, savedInstanceState: Bundle?) {
        ...
        val srcFilters = mapOf(
            views.pkgSourceGrappstore to PackageSource.Grappstore,
