...
import app.grappstore.NavGraphDirections
import app.grappstore.PackageStates
import app.grappstore.R
import app.grappstore.core.selfPkgName
import app.grappstore.databinding.MainActivityBinding
import app.grappstore.util.ActivityUtils
import app.grappstore.util.InternalSettings
import app.grappstore.util.InternalSettings.KEY_SUPPRESS_NOTIFICATION_PERMISSION_DIALOG
...
class MainActivity : AppCompatActivity() {
    companion object {
        ...
        fun internalName() = ComponentName(selfPkgName, "app.grappstore.ui.InternalMainActivityAlias")
    }
