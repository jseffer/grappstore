...
import app.grappstore.core.DependencyResolutionException
import app.grappstore.core.PackageState
import app.grappstore.core.PkgInstallerStatusReceiver
import app.grappstore.core.RPackage
import app.grappstore.core.appContext
import app.grappstore.core.getAllDependencies
import app.grappstore.core.pkgInstaller
import app.grappstore.core.pkgManager
import app.grappstore.core.selfPkgName
import app.grappstore.core.showMissingDependencyUi
import app.grappstore.core.startPackageInstallFromUi
import app.grappstore.databinding.DetailsScreenBinding
import app.grappstore.databinding.PackageListItemBinding
import app.grappstore.util.appDetailsIntent
import app.grappstore.util.getVersionNameOrVersionCode
import app.grappstore.util.isSystemPackage
import app.grappstore.util.isUpdatedSystemPackage
import app.grappstore.util.maybeSetText
import app.grappstore.util.setAvailable
